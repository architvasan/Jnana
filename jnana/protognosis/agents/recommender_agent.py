...
class RecommenderAgent(Agent):
    ...
    def _create_recommendation_prompt(self, research_goal: str, previous_run: str, previous_conclusion: str) -> str:
        ...
        base_prompt = (
            f"You are an AI co-scientist specializing in recommending the next run ('computational_design', 'molecular_dynamics', 'rag', 'analysis', 'free_energy', 'stop') to perform based on previous conclusions.\n\n"
            f"Research goal:\n{research_goal}\n\n"
        )
